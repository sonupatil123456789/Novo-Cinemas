...
class CustomMultipalChoiceChips extends StatelessWidget {
  ...
  List<ChoiceChipData> selectItem;
  Color checkColor;
  Color borderColor;
  double width;
  bool isWrapable;
            ...
            children: List.generate(dataList.length, (index) {
              ...
              return Padding(
                ...
                child: ChoiceChip(
                  ...
                  checkmarkColor: selectItem.contains(data)
                      ? checkColor
                  ...
                  shape: RoundedRectangleBorder(
                      side: BorderSide(
                          width: 1, color: selectItem.contains(data) ? context.colorPalette.transparentColor :borderColor),
                      borderRadius: BorderRadius.circular(borderRadius ?? 20)),
                  label: Text(data.title,
                      style: context.textThemeDecoration.paragraphMedium.copyWith(
                        color: selectItem.contains(data)
                            ? textColor
                            : unSelectedTextColor,
                      )),
                  selected: selectItem.contains(data) ? true : false,
