...
class CityDto extends Equatable {
  ...
  static CityModel toDomainModel(CityDto cityDto) {
    return CityModel(
      cityId: cityDto.cityId,
      countryId: cityDto.countryId,
      cityName: cityDto.cityName,
      cityNameAr: cityDto.cityNameAr,
  ...
  @override
  String toString() {
    return 'CityDto(cityId: $cityId, countryId: $countryId, cityName: $cityName, cityNameAr: $cityNameAr, isActive: $isActive, isDeleted: $isDeleted, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
